...
export type { Evolucao, Exercicio, Meta, Treino };
...
interface AuthContextValue {
	...
	sugestoes: Treino[];
	perguntarAgente: (pergunta: string) => Promise<string>;
}
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
	...
	async function updateExercicio(
		index: number,
	...
	async function perguntarAgente(pergunta: string): Promise<string> {
		const res: AgenteResponse = await api.postAgente(requireUser(), pergunta);
		return res.resposta;
	}
